...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        if launchedBefore  {
            ...
            let initialViewController = storyboard.instantiateViewControllerWithIdentifier("PAGEVIEW")
            self.window?.rootViewController = initialViewController
            self.window?.makeKeyAndVisible()
    ...
    func appearence(){
        ...
        navigationBarAppearence.barTintColor = BAR_TINT_COLOR
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "in.alternativeforyou.Alternative" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Alternative", withExtension: "momd")!
